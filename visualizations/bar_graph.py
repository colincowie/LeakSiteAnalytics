...
def plot_posting_frequency(days=365):
    ...
    fig = px.bar(df_sorted, x='group_name', y='count', color='count', title='Posting Frequency by Group over Time', color_continuous_scale='Portland')
    fig.show()

plot_posting_frequency() # number 
